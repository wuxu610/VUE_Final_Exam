...
common_vendor.index.getStorageSync("avatar");
const _sfc_main = {
  setup() {
  ...
  onShow() {
    const avatarData = common_vendor.index.getStorageSync("avatar");
    if (avatarData) {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    d: $data.bgColor,
    e: $data.localStorageImage,
    f: common_vendor.t($setup.userStore.userinfo.userName),
    g: common_vendor.t($setup.userStore.userinfo.email),
    h: $data.bgColor,
    i: common_vendor.o($options.toArticles),
    j: common_vendor.p({
      shadow: true,
      ["right-icon"]: "right",
      title: "我的文章"
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "C:/Users/Administrator/Desktop/H5考试材料/H5考试材料/uniapp-vue3-wx/pages/my/my.vue"]]);
